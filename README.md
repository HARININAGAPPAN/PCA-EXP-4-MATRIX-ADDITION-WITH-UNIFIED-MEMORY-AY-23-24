...
## OUTPUT:
<img width="1100" height="577" alt="image" src="https://github.com/user-attachments/assets/487af9da-0a24-48c2-ba99-56e37aae803b" />

<img width="1121" height="600" alt="image" src="https://github.com/user-attachments/assets/d1668c74-d6bf-4ecb-b153-2b4eb8d13d5b" />
...
## RESULT:
The program was successfully executed using CUDA Unified Memory (cudaMallocManaged). A performance comparison was conducted to analyze the impact of the memset operation on overall execution efficiency.

Key Observations:
With memset (unifmem1): GPU execution time = 0.117445 sec

Without memset (unifmem2): GPU execution time = 0.065132 sec
